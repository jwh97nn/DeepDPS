...
def add_config(cfg):
    """
    Add config for monodepth model.
    """

    # DepthNet
    cfg.MODEL.DEPTH = CN()
    cfg.MODEL.DEPTH.DEPTH_NUM_LAYERS = 18
    ...
    # PoseNet
    cfg.MODEL.POSE = CN()
    cfg.MODEL.POSE.POSE_NUM_LAYERS = 18
    cfg.MODEL.POSE.NUM_INPUT_FRAMES = 2
    cfg.MODEL.POSE.POSE_INVERT = True
    cfg.MODEL.POSE.FRAME_IDXS = [0, -1, 1]

    cfg.INPUT.HEIGHT = 192
    cfg.INPUT.WIDTH = 640

    # Color Jitter
    cfg.INPUT.COLOR_AUG = True
    cfg.INPUT.ROTATE_AUG = 0.0
    cfg.INPUT.CROP.RESCALE = (-1.0, -1.0)
    ...
    # cfg.INPUT.COLOR_JITTER.HUE = 0.1

    # Evaluation
    cfg.TEST.MIN_DEPTH = 0.001
    cfg.TEST.MAX_DEPTH = 80.0
    cfg.TEST.USE_GT_SCALE = True
    cfg.TEST.USE_EIGEN_CROP = True
    ...
    # cfg.DATASETS.ROOT = "/home/junwen/Datasets/"
