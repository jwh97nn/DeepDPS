...
class MSDeformAttnTransformerEncoderOnly(nn.Module):
    ...
    def forward(self, srcs, pos_embeds):
        ...
        src_flatten = torch.cat(src_flatten, 1)  # [B, HW*L, C]
        mask_flatten = torch.cat(mask_flatten, 1)  # [B, HW*L]
        lvl_pos_embed_flatten = torch.cat(lvl_pos_embed_flatten, 1)  # [B, HW*L, C]
...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # print(f"num_fpn_levels: {self.num_fpn_levels}")
        # assert 0
        ...
        # print(f"lateral_convs: {len(self.lateral_convs), len(self.output_convs)}")
        # assert 0
