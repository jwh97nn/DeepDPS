...
def eval(element):
    ...
    # pred = pred_cat.astype(np.uint32) * max_ins + pred_ins.astype(np.uint32)
    ...
    gts = [
        # gt_cat.astype(np.uint32) * max_ins + gt_ins.astype(np.uint32)
