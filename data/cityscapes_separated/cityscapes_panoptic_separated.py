...
def register_all_cityscapes_panoptic_separated(root):
    ...
    thing_train_id2contiguous_id = dict(
        zip(
            contiguous_id_to_thing_train_id.values(),
    ...
    stuff_train_id2contiguous_id = dict(
        zip(
            contiguous_id_to_stuff_train_id.values(),
...
if __name__ == "__main__":
    ...
    # image_dir, gt_dit, json_info = _RAW_CITYSCAPES_PANOPTIC_SPLITS[
    #     "cityscapes_fine_panoptic_train"
    # ]
    register_all_cityscapes_panoptic_separated(root)
